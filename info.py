...
API_ID = int(environ.get('API_ID', '5959775'))
API_HASH = environ.get('API_HASH', 'be6a09ccaa849cd7be9557f75e45e0e5')
BOT_TOKEN = environ.get('BOT_TOKEN', "6171533529:AAG9WLCWkqmL80KcP_XJdJYbhhp8MhApzII")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1053777957').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Spidy:MongoDB1432@autofilter.zqu7rr3.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "YourDemandZone")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'YourDemandZone')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+sAP8NkJ7xR4xNzI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/YourDemandZone')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+sAP8NkJ7xR4xNzI1')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001732815773))
...
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001657638670))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '0c10b48669ea5dccc3cf89322ca5d654b06159b4')
